 ...
 * An <code>enum</code> that lists the various chemical ID formats.
 * <p>
 *     See the individual Javadocs for each of the <code>enum</code>s for further information.
 * </p>
 *
 * @author Clay Tsay
 * @version 00.01.00
...
public enum ChemID {
    ...
    /**
     * Overrides the <code>toString</code> to print out the abbreviation/acronym of the ID type.
     * @return the non-hashmap "toString" of the <code>ChemID</code> type
     *
     * @since 00.01.00
     */
    @Override
