...
import static com.tsaysoft.nfpachemidv3.ChemID.*;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // TODO: Does this class still need to exist? Consider deleting.

        String[] fileNames = {"NFPA704_DataSet_1.json", "NFPA704_DataSet_2.json"};
        ChemDBManager database = new ChemDBManager(null, fileNames);
        ...
        if(results.size() == 0) {
            System.out.println("No ResultsActivity.");
        } else {
